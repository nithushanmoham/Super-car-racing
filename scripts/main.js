...
var bgcolor="rgb(255, 255, 16)"
var fgcolor="rgb(72, 124, 4)"
var linecolor="rgb(29, 48, 4)"
var linewidth=5;
var offset=-10;
var yRatio=0.4;
var t=0;
...
var player=new function(){
    ...
    this.truck.src="./images/araba.png"
    this.rotation=0;
    this.ySpeed=0;
    this.rSpeed=0;
    ...
    this.startBtn.src="./images/basla.png"

    this.leftBtn=new Image()
    this.leftBtn.src="./images/sol.png"

    this.rightBtn=new Image()
    this.rightBtn.src="./images/sag.png"
 
    this.gasBtn=new Image()
    this.gasBtn.src="./images/gazpedal.png"

    this.voiceBtn=new Image()
    this.voiceBtn.src="./images/muzikvar.png"

    this.noVoiceBtn=new Image()
    this.noVoiceBtn.src="./images/muzikyok.png"
...
var gameTheme=new Audio("./audio/gameTheme.mp3")
if(playing){
    gameTheme.play()
    gameTheme.loop;
}
